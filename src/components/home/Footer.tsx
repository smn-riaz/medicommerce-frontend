    ...
    <footer className="bg-background text-gray-700 dark:text-gray-300 py-10 border-t border-gray-300 dark:border-gray-700">
      <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <Link
            href="/"
            className="block mt-2 text-2xl font-bold text-primary dark:text-white"
          >
            MediCommerce
          </Link>
        ...
        <div>
          ...
          <form className="flex flex-col sm:flex-row items-center gap-2">
            ...
            />
            <Button disabled className="px-4 py-2 bg-primary dark:bg-gray-800 cursor-pointer dark:hover:bg-gray-700 text-white text-sm rounded-md transition-colors">
              Subscribe
            </Button>
          </form>
        </div>
      ...
      <div className="mt-10 text-center text-sm text-gray-500 dark:text-gray-400">
        ...
        <span className="font-semibold">MediCommerce</span>. All rights
        reserved.
      </div>
    </footer>
  );
